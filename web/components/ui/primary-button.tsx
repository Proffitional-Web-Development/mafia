...
export function PrimaryButton({
  ...
  return (
    <button
      ...
      disabled={isDisabled}
      className={cn(
        "group relative inline-flex min-h-12 items-center justify-center gap-2 overflow-hidden rounded-xl px-6 py-3 text-sm font-semibold text-white transition-all active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50",
        fullWidth && "w-full",
        variant === "primary" &&
